...
export const NAV_CRM: ReadonlyArray<NavItem> = [
  ...
  navItem('contacts', ROUTES.app.contacts.list, Users),
  navItem('companies', ROUTES.app.companies.list, Building2),
  navItem('deals', ROUTES.app.deals.list, Handshake),
  navItem('activities', ROUTES.app.activities, CalendarCheck),
  navItem('invoices', ROUTES.app.invoices.list, FileText),
  navItem('products', ROUTES.app.products.list, Package),
  navItem('reports', ROUTES.app.reports, BarChart3),
