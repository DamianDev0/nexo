...
/* ── component ── */
export function ButtonDropdown({ label, items, sound = true, style }: ButtonDropdownProps) {
            ...
            >
              {items.map((item, i) => (
                <motion.button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--bd-hover)')}
                  ...
                  style={{
                    ...
                    color: item.destructive ? 'var(--bd-danger)' : 'var(--bd-hi)',
                    fontSize: 13,
                    fontWeight: 400,
                    cursor: 'pointer',
                    outline: 'none',
