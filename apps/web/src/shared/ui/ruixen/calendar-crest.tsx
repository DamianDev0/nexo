...
export function CalendarCrest({
      ...
      <div>
        ...
        >
          ...
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            /* Range logic */
            const inRange =
              effStart !== null && effEnd !== null && dateKey >= effStart && dateKey <= effEnd
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  bgCls,
                  !inRange && 'rounded-[10px] hover:bg-neutral-100 dark:hover:bg-neutral-800',
                )}
                style={{
                  width: CELL,
                  height: CELL,
              ...
              >
                <span
                  ...
                  style={{
                    fontWeight: isStart || isEnd || isToday ? 650 : inRange ? 500 : 400,
                    lineHeight: 1,
                  }}
                >
                  {d}
  ...
  const rangeLabel = (() => {
    ...
    if (effStart) {
      return isConfirmed ? formatDate(effStart) : `${formatDate(effStart)} — select end`
    }
    return null
  })()
