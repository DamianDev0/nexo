...
export function RangeCalendar({
  ...
  const grid = useMemo(() => getGrid(viewYear, viewMonth), [viewYear, viewMonth])
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="flex w-full items-center justify-between" style={{ width: CELL * 7 }}>
        <button
          onClick={goPrev}
      ...
      <div className="relative overflow-hidden" style={{ width: CELL * 7, height: CELL * 6 }}>
        <AnimatePresence initial={false} mode="popLayout">
          ...
          >
            {grid.map((date, i) => {
              if (!date) {
                return <div key={`empty-${i}`} style={{ width: CELL, height: CELL }} />
              }
              ...
              const roundR = isSingle || isEnd || col === 6 || dayNum === daysInMonth
