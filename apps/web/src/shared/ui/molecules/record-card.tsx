...
function RecordCardList({ children, className }: Readonly<RecordCardListProps>) {
  return (
    <div role="list" data-slot="record-card-list" className={cn('flex flex-col gap-2', className)}>
      {children}
    </div>
  )
}

type RecordCardRootProps = {
  readonly children: ReactNode
  readonly className?: string
}

function RecordCardRoot({ children, className }: Readonly<RecordCardRootProps>) {
  return (
    <article
      role="listitem"
...
function RecordCardRow({ children, className }: Readonly<RecordCardRootProps>) {
  return (
    <div
      role="listitem"
...
function RecordCardHeader({ children, className }: Readonly<RecordCardRootProps>) {
  return (
    <div
...
function RecordCardAside({ children, className }: Readonly<RecordCardRootProps>) {
  return (
...
function RecordCardSlot({ children, className }: Readonly<RecordCardRootProps>) {
  return (
