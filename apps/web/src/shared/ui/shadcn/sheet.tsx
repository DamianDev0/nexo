  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition data-[state=closed]:animate-out data-[state=closed]:duration-250 data-[state=closed]:ease-in data-[state=open]:animate-in data-[state=open]:duration-350 data-[state=open]:ease-out',
          side === 'right' &&
