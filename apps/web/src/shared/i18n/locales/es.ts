const es = {
  ...
  contacts: {
    ...
    columnHints: {
      email: 'Correo principal del contacto.',
    ...
    hints: {
      ...
      pending_other: '{{count}} contactos nuevos sin gestionar',
      clients_one: '{{count}} contacto ya es cliente',
      clients_other: '{{count}} contactos ya son clientes',
      withoutEmail_one: '{{count}} contacto de esta página no tiene email',
      withoutEmail_other: '{{count}} contactos de esta página no tienen email',
      total_one: '{{count}} contacto en tu workspace',
      total_other: '{{count}} contactos en tu workspace',
    },
    bulk: {
    ...
    import: {
      ...
      steps: {
        upload: 'Sube un archivo CSV o Excel con tus contactos.',
        configure: 'Decide qué hacer con los contactos que ya existen.',
      ...
      upload: {
        ...
        templateName: 'plantilla-contactos.csv',
      },
      map: {
      ...
      review: {
        ...
        skipSummary:
          'Se crearán {{ready}} contactos. Los repetidos se omiten y {{errors}} filas con errores no entran.',
        updateSummary:
          'Se procesarán {{ready}} contactos: los nuevos se crean y los que ya existan se actualizan. {{errors}} filas con errores no entran.',
        createSummary:
          'Se crearán {{ready}} contactos, incluso si ya existe uno igual. {{errors}} filas con errores no entran.',
      },
      strategy: {
        title: 'Si el contacto ya existe',
        skip: 'Omitir',
        update: 'Actualizar',
        create: 'Crear otro',
        skipHint: 'Solo se crean los contactos nuevos. Los repetidos se dejan como están.',
        updateHint:
          'Los nuevos se crean y los que ya existan se actualizan con los datos del archivo.',
        createHint: 'Se crea un contacto nuevo aunque ya exista uno igual.',
        matchNote: 'Buscamos coincidencias por email o número de documento.',
      },
      done: {
      ...
      actions: {
        ...
        continue: 'Continuar',
        checking: 'Revisando...',
        importCount: 'Importar {{count}} contactos',
