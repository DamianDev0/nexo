const es = {
  ...
  contacts: {
    ...
    columnHints: {
      ...
      jobTitle: 'Cargo que ocupa dentro de su empresa.',
      ...
      type: 'Relación comercial: cliente, proveedor, socio u otro.',
      phone: 'Teléfono principal; si no hay, se muestra el WhatsApp.',
      city: 'Municipio registrado en la dirección del {{entity}}.',
      leadScore: 'Puntaje calculado según interacción y datos completos.',
    ...
    form: {
      ...
      lifecycleStage: 'Ciclo de vida',
      type: 'Tipo',
      typePlaceholder: '¿Qué es este {{entity}} para tu negocio?',
      typeOtherLabel: '¿Cuál?',
      typeOtherPlaceholder: 'Describe el tipo de {{entity}}',
    ...
    toasts: {
      ...
      archived_one: '{{entity}} archivado',
      archived_other: '{{entities}} archivados',
      archivedPartial: 'Se archivaron {{archived}} de {{total}} {{entities}}',
    },
    errors: {
      firstNameRequired: 'El nombre es obligatorio',
      emailInvalid: 'Ingresa un email válido',
      phoneInvalid: 'Número inválido: 10 dígitos, celular 3XX o fijo 60X',
      typeOtherRequired: 'Indica cuál es el tipo de {{entity}}',
  ...
  settings: {
    ...
    taxonomy: {
      ...
      typesDescription:
        'Los tipos clasifican qué es cada {{entity}} para tu negocio. Renómbralos, cámbiales el color, reordénalos o crea los tuyos.',
