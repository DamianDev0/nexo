  ...
  settings: {
    ...
    taxonomy: {
      ...
      lifecycleStageDescription:
        'Las etapas del ciclo de vida describen la relación del contacto con tu negocio. Renómbralas, reordénalas o crea las tuyas.',
    ...
    fields: {
      description:
        'Los campos personalizados guardan la información propia de tu negocio en contactos, empresas y negocios.',
      add: 'Agregar',
