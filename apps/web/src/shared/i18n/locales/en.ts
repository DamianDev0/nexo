  ...
  settings: {
    ...
    taxonomy: {
      ...
      lifecycleStageDescription:
        'Lifecycle stages describe the contact’s relationship with your business. Rename and reorder them, or add your own.',
    ...
    fields: {
      description:
        'Custom fields store the data your business cares about on contacts, companies and deals.',
      add: 'Add',
