  ...
  common: {
    ...
    table: {
      ...
      selection: {
        ...
        pageSelected_one: 'You selected the {{count}} on this page.',
        pageSelected_other: 'You selected all {{count}} on this page.',
        allSelected_one: 'You selected the {{count}}.',
        allSelected_other: 'You selected all {{count}}.',
    ...
    bulk: {
      ...
      dialogs: {
        tags: {
          ...
          search: 'Search tag…',
          empty: 'No tags match',
          confirm_one: 'Apply {{count}} tag',
          confirm_other: 'Apply {{count}} tags',
        },
        status: {
          title_one: 'Change status of {{count}} record',
          title_other: 'Change status of {{count}} records',
