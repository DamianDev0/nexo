const en = {
  ...
  contacts: {
    ...
    import: {
      ...
      steps: {
        upload: 'Upload a CSV or Excel file with your contacts.',
        configure: 'Decide what to do with contacts that already exist.',
      ...
      upload: {
        ...
        templateName: 'contacts-template.csv',
      },
      map: {
        title: 'File columns',
      ...
      review: {
        ...
        skipSummary:
          '{{ready}} contacts will be created. Duplicates are skipped and {{errors}} rows with errors will not be imported.',
        updateSummary:
          '{{ready}} contacts will be processed: new ones are created and existing ones are updated. {{errors}} rows with errors will not be imported.',
        createSummary:
          '{{ready}} contacts will be created, even if a match already exists. {{errors}} rows with errors will not be imported.',
      },
      strategy: {
        title: 'If the contact already exists',
        skip: 'Skip',
        update: 'Update',
        create: 'Create another',
        skipHint: 'Only new contacts are created. Existing ones are left untouched.',
        updateHint: 'New contacts are created and existing ones are updated with the file data.',
        createHint: 'A new contact is created even if a match already exists.',
        matchNote: 'We match contacts by email or document number.',
      },
      done: {
