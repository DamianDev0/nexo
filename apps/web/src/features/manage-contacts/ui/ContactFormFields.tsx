  ...
  return (
    <div className="flex flex-col gap-3.5">
      <div className="grid grid-cols-2 gap-3.5">
        <ControlledField control={control} name="firstName" label={t('contacts.form.firstName')} />
        <ControlledField control={control} name="lastName" label={t('contacts.form.lastName')} />
      </div>
      <ControlledField
        control={control}
        name="email"
      ...
      />
      <div className="grid grid-cols-2 gap-3.5">
        <ControlledField control={control} name="phone" label={t('contacts.form.phone')} />
        <ControlledField control={control} name="whatsapp" label={t('contacts.form.whatsapp')} />
      </div>
      <div className="grid grid-cols-2 gap-3.5">
        <ControlledField control={control} name="city" label={t('contacts.form.city')} />
        <Controller
          control={control}
          name="status"
          render={({ field }) => (
