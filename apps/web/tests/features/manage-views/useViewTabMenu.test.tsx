...
import { useViewTabMenu, ViewTabDialogs } from '@/features/manage-views'

const update = vi.fn()
const duplicate = vi.fn()
const remove = vi.fn()

vi.mock('@/features/manage-views/query/useViewsAdmin', () => ({
  useViewsAdmin: () => ({
    create: vi.fn(),
...
describe('useViewTabMenu + ViewTabDialogs', () => {
  ...
  it('deletes the targeted view on slide confirm', async () => {
    ...
    await user.click(screen.getByRole('button', { name: 'views.slideToDelete' }))
